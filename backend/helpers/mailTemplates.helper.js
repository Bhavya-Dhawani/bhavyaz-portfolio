...
<html lang="en">
    ...
    >
        ...
        >
            ...
            <p>Best regards,<br />Dole Shole</p>
        </div>
        <div
            style="
                text-align: center;
...
<html lang="en">
    <head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>Welcome to Dole Shole</title>
    </head>
    <body
        style="
            font-family: Arial, sans-serif;
    ...
    >
        <div
            ...
            "
        >
            <h1 style="color: white; margin: 0">Welcome to Dole Shole</h1>
        </div>
        <div
            style="
                background-color: #f9f9f9;
        ...
        >
            <p>Hi {name},</p>
            <p>
                Welcome to our community! We're excited to have you on board and look forward to supporting you on your journey.
            </p>
            <p>
            ...
            <p>Thanks again and welcome!<br />Dole Shole</p>
        </div>
        <div
            style="
                text-align: center;
...
<html lang="en">
    ...
    >
        ...
        >
            ...
            <p>
                If you did not initiate this password reset, please contact us immediately.
            </p>
